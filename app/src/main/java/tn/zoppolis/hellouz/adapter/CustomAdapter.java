package tn.zoppolis.hellouz.adapter;
...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final ImageView icon;
         // private final ProgressBar papa;
        ...
        public ViewHolder(View v) {
            ...
            /*ProgressBar papa =(ProgressBar) v.findViewById(R.id.papa);*/
        }
      ...
      // public ProgressBar getProgressBar() {return papa ;     }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_veiw_event, viewGroup, false);
